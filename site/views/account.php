        ...
        <div class="account-login">
            ...
            <div class="my-account-page">
                <div class="row">
                                ...
                                <div class="col-md-5">
                                    <div class="text-center">
                                        ...
                                        <div class="service-desc text-center" style="margin: 15px 0 0 30px;display:flex;width:100%">
                                            <!-- <h4 style="margin-top: 30px; ">Cấp thành viên: <?= $_SESSION["user"]["rank_id"] ?></h4>
                    ...
                    <div class="col-md-4">
                        <div class="col-sm-12 col-md-12 col-xs-12">
                            <a href="index.php?option=user&act=order">
                        ...
                        <div class="col-sm-12 col-md-12 col-xs-12">
                            <a href="index.php?option=user&act=info">
                                <div class="account-box">
                                    <div class="service-box">
                        ...
                        <div class="col-sm-12 col-md-12 col-xs-12">
                            <a href="index.php?option=user&act=whislist">
                                <div class="account-box">
                                    <div class="service-box">
                                        <div class="service-icon"> <i class="fa fa-user"></i> </div>
                                        <div class="service-desc">
                        ...
                        <!-- <a style="width:200px; background-color:white;color:black" class="btn btn-block btn-success btn-sm" href="#">Thông tin tài khoản</a><br>
                        <a style="width:200px; background-color:white;color:black" class="btn btn-block btn-success btn-sm" href="index.php?option=user&act=order">Đơn hàng đã đặt</a><br>
                 -->