                            ...
                            <table id="datatable" style="width:100%" class="display table table-bordered table-striped table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" width="200px">Thông tin slider</th>
                                        <th class="text-center" width="200px">Vị trí</th>
                                ...
                                <tbody>
                                    <?php foreach ($slider_list as $key => $row) : ?>
                                        ...
                                        <tr>        
                                            ...
                                            <td class="text-center">
                                            <?php if ($row['status'] == 1) : ?>
                                                    <a class="btn btn-sm btn-success" href="index.php?option=slider&act=status&id=<?= $row['id']; ?>"><i class="fa fa-toggle-on"></i></a>
                                                <?php else : ?>
                                                    <a class="btn btn-sm btn-danger" href="index.php?option=slider&act=status&id=<?= $row['id']; ?>"><i class="fa fa-toggle-off"></i></a>
                                                <?php endif; ?>
                                                <a class="btn btn-sm btn-info" href="index.php?option=slider&act=update&id=<?= $row['id']; ?>"><i class="fa fa-edit"></i></a>
                                                <a class="btn btn-sm btn-danger" href="index.php?option=slider&act=deltrash&id=<?= $row['id']; ?>"><i class="fa fa-trash"></i></a>
                                            </td>
