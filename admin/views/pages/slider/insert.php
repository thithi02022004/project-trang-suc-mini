            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="index.php?option=slider">Quản lí slider</a></li>
            ...
            <div class="card card-primary">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <h3 class="card-title font-weight-bold py-2">Thêm slider</h3>
                        <div class="card-tools">
                            <button type="submit" name="THEMSLIDER" class="btn btn-success"><i class="fa fa-save"></i> Lưu[Thêm]</button>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <select id="status" name="status" class="form-control custom-select">
                                    <option selected>[--- Trạng thái slider ---]</option>
