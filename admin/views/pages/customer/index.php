                                ...
                                <tbody>
                                    <?php foreach ($customer_list as $row) : ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <?php if ($row['status'] == 1) : ?>
                                                    <a class="btn btn-sm btn-success" href="index.php?option=customer&act=status&id=<?= $row['id']; ?>"><i class="fa fa-toggle-on"></i></a>
                                                <?php else : ?>
                                                    <a class="btn btn-sm btn-danger" href="index.php?option=customer&act=status&id=<?= $row['id']; ?>"><i class="fa fa-toggle-off"></i></a>
                                                <?php endif; ?>
                                                <a class="btn btn-sm btn-info" href="index.php?option=customer&act=update&id=<?= $row['id']; ?>"><i class="fa fa-edit"></i></a>
                                                <a class="btn btn-sm btn-danger" href="index.php?option=customer&act=deltrash&id=<?= $row['id']; ?>"><i class="fa fa-trash"></i></a>
                                            </td>
