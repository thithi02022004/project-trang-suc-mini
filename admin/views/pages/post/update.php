            ...
            <div class="card card-primary">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <h3 class="card-title font-weight-bold py-2">Cập nhật bài viết</h3>
                        <div class="card-tools">
                            <button type="submit" name="CAPNHATBAIVIET" class="btn btn-success"><i class="fa fa-save"></i> Lưu[CẬP NHẬT]</button>
                ...
                <div class="card-footer">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="card-tools">
                            <button type="submit" name="CAPNHATBAIVIET" class="btn btn-success">
