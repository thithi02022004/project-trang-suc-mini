            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="index.php?option=post">Bài viết</a></li>
            ...
            <div class="card card-primary">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="card-tools">
                            <button type="submit" name="THEMBAIVIET" class="btn btn-success"><i class="fa fa-save"></i> Lưu[Thêm]</button>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="topid">Loại Bài viết (*):</label>
                                <select id="topid" name="topid" class="form-control custom-select">
                            ...
                            <div class="form-group align-items-center">
                                ...
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="img" name="img" onchange="updateFileName()">
                ...
                <div class="card-footer">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="card-tools">
                            <button type="submit" name="THEMBAIVIET" class="btn btn-success">
