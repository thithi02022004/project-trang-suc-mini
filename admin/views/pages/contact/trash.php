                                ...
                                <tbody>
                                    <?php foreach ($list_contact as $row) : ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a class="btn btn-sm btn-info" href="index.php?option=contact&act=retrash&id=<?= $row['id']; ?>"><i class="fa fa-undo"></i></a>
                                                <a class="btn btn-sm btn-danger" href="index.php?option=contact&act=deleteh&id=<?= $row['id']; ?>"><i class="fa fa-trash"></i></a>
                                            </td>
