            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="index.php?option=banner">banner</a></li>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                <h3 class="card-title font-weight-bold py-2">Quản lý thùng rác banner</h3>
                            ...
                            <table id="datatable" class="table table-bordered table-striped table-compact table-hover">
                                ...
                                <?php foreach ($banner_list as $key => $row) :  ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a class="btn btn-sm btn-info" href="index.php?option=banner&act=retrash&id=<?= $row['id']; ?>"><i class="fa fa-undo"></i></a>
                                                <a class="btn btn-sm btn-danger" href="index.php?option=banner&act=delete&id=<?= $row['id']; ?>"><i class="fa fa-trash"></i></a>
                                            </td>
