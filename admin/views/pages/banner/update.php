            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="index.php?option=banner">banner sản phẩm</a></li>
                ...
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="card-tools">
                            <button type="submit" name="CAPNHATBANNER" class="btn btn-success"><i class="fa fa-save"></i> Lưu[Thêm]</button>
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="form-group">
                                <label for="img">Hình ảnh hiện tại (*)</label><br>
                                    <img width="200" src="../public/images/banner/<?=$row['img']?>" alt="">
                                <input type="hidden" name="id" value="<?= $row['id'] ?>">
                            </div>
                        </div>
                        <div class="col-md-3">
                            ...
                            <div class="form-group align-items-center">
                                <label for="img">Hình ảnh banner (*):</label>
