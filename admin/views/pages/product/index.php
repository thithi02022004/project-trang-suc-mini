                                ...
                                <tbody>
                                    <?php foreach ($product_list as $row) : ?>
                                        ...
                                        <tr>
                                                    ...
                                                    <div class="carousel-inner">
                                                        <?php foreach ($row['image'] as $key => $img) : ?>
                                                            <div class="carousel-item <?= ($key === 0) ? 'active' : ''; ?>">
                                                                <img src="../public/images/product/<?= $img['image']; ?>" class="d-block w-100" >
                                                            </div>
                                                        <?php endforeach; ?>
                                                    </div>
                                            ...
                                            <td class="text-center">
                                                <?php if ($row['status'] == 1) : ?>
                                                    <a class="btn btn-sm btn-success" href="index.php?option=product&act=status&id=<?= $row['id']; ?>"><i class="fa fa-toggle-on"></i></a>
                                                <?php else : ?>
                                                    <a class="btn btn-sm btn-danger" href="index.php?option=product&act=status&id=<?= $row['id']; ?>"><i class="fa fa-toggle-off"></i></a>
                                                <?php endif; ?>
